class life_wanted_menu {
	...
	class controlsBackground {
		...
		class nAtabletWA : Life_RscPicture {
			idc = 3002;
	...
	class controls {
		...
		class WantedList : Life_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[] spawn noaim_fnc_wantedGrab";
		...
		class PardonButtonKey : Life_RscButtonMenu {
			...
			onButtonClick = "[] call noaim_fnc_pardon; closeDialog 0;";
		...
		class ButtonWantedAdd : life_RscButtonMenu {
			idc = 9800;
			text = "Add";
			onButtonClick = "[] call noaim_fnc_wantedAddP;";
