class Life_ticket_give
{
	...
	class controls 
	{
		...
		class payTicket: Life_RscButtonMenu {
			...
			onButtonClick = "[] call noaim_fnc_ticketGive";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
...
class Life_ticket_pay
{
	...
	class controls 
	{
		...
		class payTicket: Life_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call noaim_fnc_ticketPay;";
...
class life_ticket_give_fw
{
	...
	class controls
	{
		...
		class payTicket: life_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "closeDialog 0; [] call noaim_fnc_fw_ticket_give";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
...
class life_ticket_pay_fw
{
	...
	class controls
	{
		...
		class payTicket: life_RscButtonMenu {
			...
			text = "Bezahlen";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call noaim_fnc_fw_ticket_pay;";
			x = 0.2 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.42 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
