class Life_Vehicle_Shop_v2
{
	...
	onUnLoad = "[] call noaim_fnc_vehicleShopEnd3DPreview";
	...
	class controlsBackground
	{
		...
		class RentCar: Life_RscButtonMenu
		{
			...
			onButtonClick = "[false] spawn noaim_fnc_vehicleShopBuy;";
			x = 0.0298555 * safezoneW + safezoneX;
		...
		class BuyCar: life_RscButtonMenu
		{
			idc = 2309;
			text = "$STR_Global_Buy";
			onButtonClick = "[true] spawn noaim_fnc_vehicleShopBuy;";
	...
	class controls
	{
		class VehicleList: Life_RscListBox
		{
			...
			onLBSelChanged = "_this call noaim_fnc_vehicleShopLBChange";
		...
		{
			idc = 2304;
			onLBSelChanged = "[] spawn noaim_fnc_vehiclecolor3DRefresh;";
			x = 0.0298555 * safezoneW + safezoneX;
