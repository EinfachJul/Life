...
_vehicleColor = [_className,_dataArr select 1] call noaim_fnc_vehicleColorStr;
_vehicleInfo = [_className] call noaim_fnc_fetchVehInfo;
_trunkSpace = [_className] call noaim_fnc_vehicleWeightCfg;
...
_sellPrice = [playerSide,life_garage_type,_className] call noaim_fnc_getVehicleSellPrice;
...
(getControl(2800,2803)) ctrlSetStructuredText parseText format[
	...
	",
[_retrievePrice] call noaim_fnc_numberText,
[_sellPrice] call noaim_fnc_numberText,
