...
if(!(createDialog "life_spawn_selection")) exitWith {[] call noaim_fnc_spawnMenu;};
(findDisplay 38500) displaySetEventHandler ["keyDown","_this call noaim_fnc_displayHandler"];
...
[((findDisplay 38500) displayCtrl 38502),1,0.1,getMarkerPos (_sp select 0)] call noaim_fnc_setMapPosition;
