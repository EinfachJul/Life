...
switch (typeOf _vehicle) do {
	...
	case "I_G_Van_01_transport_F":{_attach =  [[-0.7, -0.25, 1.5],[0.7, -0.25, 1.5]];};
	case "C_Hatchback_01_F": {_attach = [[-0.6, 2, -0.95], [0.6, 2, -0.95]];};
    case "C_Hatchback_01_sport_F": {_attach = [[-0.6, 2, -0.95], [0.6, 2, -0.95]];};
	case "I_Truck_02_covered_F":{_attach =  [[-0.37, 0.0, 0.56],[-0.37, 0.0, 0.56]];};
	...
	case "B_Truck_01_mover_F": {_attach = [[-0.8,5,-0.3],[0.8,5,-0.3]];}; //TEST
	case "I_Truck_02_box_F":{_attach = [[-1.2, 3.73, -0.6],[0.98, 3.73, -0.6]];};
};
