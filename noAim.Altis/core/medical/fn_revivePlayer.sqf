...
["Revive_Prof",_AddExpAmount] call noaim_fnc_addExp;
//[[0,format["Sie erhalten %1 XP fuer das Wiederbeleben", _addExpAmount]],"noaim_fnc_broadcast",player,false] spawn noaim_fnc_TRY;
[0,format["Sie erhalten %1 XP fuer das Wiederbeleben", _addExpAmount]] remoteExecCall ["noaim_fnc_broadcast",player];

life_zgazzy = life_zgazzy + (call life_revive_fee); 
life_action_inUse = false;
_target setVariable["Revive",TRUE,TRUE];
//[[profileName],"noaim_fnc_revived",_target,FALSE] spawn noaim_fnc_DONE;
[profileName] remoteExec ["noaim_fnc_revived",_target];
titleText[format[localize "STR_Medic_RevivePayReceive",_targetName,[(call life_revive_fee)] call noaim_fnc_numberText],"PLAIN"];
