...
if(!([false,"fuelF",1] call noaim_fnc_handleInv)) exitWith {};
...
switch (true) do
{
	case (_vehicle isKindOF "LandVehicle"):
	{
		...
		{
			//[[_vehicle,(Fuel _vehicle) + 0.5],"noaim_fnc_setFuel",_vehicle,false] spawn noaim_fnc_DONE;
			[_vehicle,(Fuel _vehicle) + 0.5] remoteExec ["noaim_fnc_setFuel",_vehicle];
		}
		else
		{
	...
	case (_vehicle isKindOf "Air"):
	{
		if(!local _vehicle) then
		{
			//[[_vehicle,(Fuel _vehicle) + 0.2],"noaim_fnc_setFuel",_vehicle,false] spawn noaim_fnc_DONE;
			[_vehicle,(Fuel _vehicle) + 0.2] remoteExec ["noaim_fnc_setFuel",_vehicle];
		}
		else
		{
	...
	case (_vehicle isKindOf "Ship"):
	{
		if(!local _vehicle) then
		{
			//[[_vehicle,(Fuel _vehicle) + 0.35],"noaim_fnc_setFuel",_vehicle,false] spawn noaim_fnc_DONE;
			[_vehicle,(Fuel _vehicle) + 0.35] remoteExec ["noaim_fnc_setFuel",_vehicle];
		}
		else
		{
...
[true,"fuelE",1] call noaim_fnc_handleInv;