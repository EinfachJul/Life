...
[] spawn
{
	...
	{
		//[[0,"STR_Cop_Ticket_Refuse",true,[profileName]],"noaim_fnc_broadcast",west,false] spawn noaim_fnc_TRY;
		[0,"STR_Cop_Ticket_Refuse",true,[profileName]] remoteExecCall ["noaim_fnc_broadcast",west];
		[1,"STR_Cop_Ticket_Refuse",true,[profileName]] remoteExecCall ["noaim_fnc_broadcast",life_ticket_cop];
		//[[1,"STR_Cop_Ticket_Refuse",true,[profileName]],"noaim_fnc_broadcast",life_ticket_cop,false] spawn noaim_fnc_TRY;
	};
};