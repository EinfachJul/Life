...
_blacklist = [1] call noaim_fnc_seizeCfg;

[] call noaim_fnc_saveGear;

_itemArray = life_gear;
if(count _itemArray == 0) exitWith {
	//[[52, player, format["%1 Hat keine Waffen bei sich.", name cursorTarget]],"TON_fnc_logIt",false,false] spawn noaim_fnc_LAST;
	[52, player, format["%1 Hat keine Waffen bei sich.", name cursorTarget]] remoteExec ["TON_fnc_logIt",2];
};
...
[] call noaim_fnc_civSeizeGear;
titleText["Ihre Waffen und Magazine wurden entfernt und sie wurden auf die Fahrdungsliste gesetzt.","PLAIN"];
//[[getPlayerUID player,profileName,"34"],"noaim_fnc_wantedAdd",false,false] spawn noaim_fnc_TRY;
[getPlayerUID player,profileName,"34"] remoteExec ["noaim_fnc_wantedAdd",2];