...
if(_action) then {
	...
	//[[_unit,grpPlayer],"TON_fnc_clientGangLeader",_unit,false] spawn noaim_fnc_DONE; //Boot that bitch!
	//[[3,grpPlayer],"TON_fnc_updateGang",false,false] spawn noaim_fnc_DONE; //Update the database.
