...
switch(true) do
		{
		   ...
		   case (_swmarkt < 2) : 
		   {
			...
			_text = "Der Drogendealer ist für 30 Minuten beim Ölhändler."; _absender = "Der Informant"; [_text,_absender,0] spawn clientMessage	;
			EMonkeys_drogen_active = true;			
            };
			...
			_text = "Der Drogendealer ist für 30 Minuten bei der Glashütte."; _absender = "Der Informant"; [_text,_absender,0] spawn clientMessage;
			EMonkeys_drogen_active = true;			
            };
			case (_swmarkt < 13) : 
			{
