/*File:fn_reb_loadout_base.sqf Author:[midgetgrimm] */
...
if(_action) then {
	...
	if(license_civ_rebel) then {		
		...
		titleText ["Das Kostet sie 550,000 €, direkt von ihrem Bankkonto.","PLAIN"];
		...
		_weapon = ["arifle_MXC_F","arifle_MX_F"];
