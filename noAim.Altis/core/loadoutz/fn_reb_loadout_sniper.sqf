...
private ["_loadoutName","_action","_guncost","_clothings","_vest","_headgear","_backpacks","_nvgoggles","_nv"];
...
_loadoutName = "Sniper EBR Ausruestung";
_action = [
...
if(_action) then {
	if(license_civ_rebel) then {
		...
		titleText ["Das Kostet sie 950,000 €, direkt von ihrem Bankkonto.","PLAIN"];
