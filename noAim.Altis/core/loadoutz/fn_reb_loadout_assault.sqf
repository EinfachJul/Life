/*
File:fn_rebelnew1.sqf 
*/
private ["_loadoutName","_action","_guncost","_clothings","_vest","_headgear","_backpacks","_nvgoggles","_nv","_weapon","_wep"];
...
_loadoutName = "MK14 Assault Ausruestung";
_action = [
...
if(_action) then {
	...
	if(license_civ_rebel) then {	
		...
		titleText ["Das Kostet sie 2,000,000 €, direkt von ihrem Bankkonto.","PLAIN"];
		uiSleep 1;
		...
		_clothings = ["U_B_FullGhillie_lsh","U_B_FullGhillie_sard","U_B_FullGhillie_ard","U_O_FullGhillie_lsh","U_O_FullGhillie_sard","U_O_FullGhillie_ard","U_I_FullGhillie_lsh","U_I_FullGhillie_sard","U_I_FullGhillie_ard","U_B_GhillieSuit","U_O_GhillieSuit"];
		...
		_backpacks = ["B_Kitbag_cbr","B_Kitbag_rgr","B_Kitbag_mcamo","B_Kitbag_sgg"];
		...
		_weapon = ["srifle_DMR_06_camo_F","srifle_DMR_06_olive_F"];
