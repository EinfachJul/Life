...
if((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "ReammoBox_F") || !(_vehicle isKindOf "StaticWeapon") || !(_vehicle isKindOf "Ship")) then
{
	...
	_owners = [_owners] call noaim_fnc_vehicleOwners;
