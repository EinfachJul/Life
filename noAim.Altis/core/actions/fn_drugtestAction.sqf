private["_unit","_dText","_weed","_cocaine","_haschisch","_sprit","_heroin","_alk"];
//ARYX DROGEN
_unit = cursorTarget;
...
if(_unit getVariable["drug_haschisch",false]) then { _haschisch = "Positiv"; } else { _haschisch = "Negativ"; };
...
hint parseText format["<t color='#FF0000'><t size='1'>%1</t></t><br/><t color='#FFD700'>Marihuana: </t>%2<br/><t color='#FFD700'>Kokain: </t>%3<br/><t color='#FFD700'>Haschisch: </t>%4<br/><t color='#FFD700'>Spirituosen: </t>%5<br/><t color='#FFD700'>Heroin: </t>%6<br/><t color='#FFD700'>Alkohol: </t>%7<br/><br/><t color='#FF0000'>%8</t>"
,name _unit,_weed,_cocaine,_haschisch,_sprit,_heroin,_alk];