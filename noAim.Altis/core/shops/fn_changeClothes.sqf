...
[_data,true,nil,nil,nil,nil,nil,true] call noaim_fnc_handleItem;
life_cMenu_lock = false;
_price ctrlSetStructuredText parseText format [(localize "STR_GNOTF_Price")+ " <t color='#8cff9b'>€%1</t>",[(_control lbValue _selection)] call noaim_fnc_numberText];
...
[player, uniform player] call noaim_fnc_updateClothing;
_total ctrlSetStructuredText parseText format [(localize "STR_Shop_Total")+ " <t color='#8cff9b'>€%1</t>",[_totalPrice] call noaim_fnc_numberText];

[] call noaim_fnc_updateClothing; //Oktober