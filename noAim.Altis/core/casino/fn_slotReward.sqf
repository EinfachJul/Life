...
// Params
_rowa = [_this,0,0,[0]] call BIS_fnc_param;
_rowb = [_this,1,0,[0]] call BIS_fnc_param;
_rowc = [_this,2,0,[0]] call BIS_fnc_param;
...
if(_reward > 0) then
{
	...
	life_znorak = life_znorak + _reward;
	...
	[
		"You've won €%1 %2.",
		[_reward] call noaim_fnc_numberText,
		_extra
	];
};