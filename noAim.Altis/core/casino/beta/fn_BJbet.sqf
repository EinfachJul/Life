...
if(life_znorak < _betamt) exitWith {hint format["Du hast nicht genug Geld dabei, zum spielen brauchst du %1€.",_betamt];};
life_znorak = life_znorak - _betamt;
