...
if(life_znorak < _price) exitWith { hint format["Sie besitzen zu wenig Geld um an diesem Einarmiger Banditen zu Spielen, Sie benoetigen (€%1)",[_price] call noaim_fnc_numberText]; };
...
//[[(life_casino_slotmachine select 0), "slot_pull", 5],"noaim_fnc_playSound",true,false] call noaim_fnc_TRY;
[(life_casino_slotmachine select 0), "slot_pull", 5] remoteExec ["noaim_fnc_playSound",-2];
...
[_slots] spawn 
{
	...
	//[[(life_casino_slotmachine select 0), "slot_roll_stop", 5],"noaim_fnc_playSound",true,false] call noaim_fnc_LAST;
	[(life_casino_slotmachine select 0), "slot_roll_stop", 5] remoteExec ["noaim_fnc_playSound",-2];
};
...
[_slots] spawn 
{
	...
	//[[(life_casino_slotmachine select 0), "slot_roll_stop", 5],"noaim_fnc_playSound",true,false] call noaim_fnc_TRY;
	[(life_casino_slotmachine select 0), "slot_roll_stop", 5] remoteExec ["noaim_fnc_playSound",-2];
};
...
[_rowaIndex,_rowbIndex,_rowcIndex] call noaim_fnc_slotReward;
sleep 0.1;
