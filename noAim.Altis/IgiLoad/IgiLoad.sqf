...
//	Author: Igi_PL modified by ArYx																				//
...
if (isnil "IL_Variables") then
{
	...
	IL_Num_Slots_VAN = -3;
	IL_Num_Slots_MOHAWK = -7; //-6 vor 27.02.2016
	IL_num_Slots_CHINOOK = -8;
	IL_Num_Slots_KAMAZ = -4;
	IL_Num_Slots_TEMPEST = -5; //-5 vor 27.02.2016
	...
	IL_Para_Drop_Open_ATL = 150; //250 vor 27.02.2016
	IL_Para_Jump_Open_ATL = 150; //250 vor 27.02.2016
	...
	IL_Para_Light_Default = "Chemlight_red";
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F","C_Offroad_01_repair_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_mover_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F"];
	...
	IL_Supported_Vehicles_CHINOOK = ["B_Heli_Transport_03_unarmed_F"];
    ...
    IL_Supported_Vehicles_Huron = ["B_Heli_Transport_03_unarmed_green_F","B_Heli_Transport_03_F"];
	
	IL_Supported_Vehicles_All = IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_VAN + IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_Huron;

	// Vehicles with the ability to dropping the load on the parachute
	IL_Para_Drop_Vehicles = IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_Huron;
	...
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "C_Offroad_01_repair_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F"];
	...
	IL_Supported_SDV = ["I_SDV_01_F", "O_SDV_01_F", "B_mas_mar_SDV_01_F"];
    ...
    IL_Supported_Huron_Cargo = ["B_Slingload_01_Cargo_F","Land_Pod_Heli_Transport_04_covered_F"];
	//TODO
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_Huron_Cargo + IL_Supported_UGV + IL_Supported_VAN;
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Quadbike;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_Huron_Cargo + IL_Supported_UGV;
	...
	IL_Supported_Cargo_Veh_CHINOOK = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_Huron_Cargo + IL_Supported_UGV;
	IL_Supported_Cargo_NonVeh_CHINOOK = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank;
    ...
    IL_Supported_Cargo_Veh_Huron = IL_Supported_Hatchback + IL_Supported_Huron_Cargo;
	...
	IL_Supported_Cargo_Huron = IL_Supported_Cargo_Veh_Mohawk + IL_Supported_Cargo_NonVeh_Mohawk;
};
//	END VARIABLES
...
//	END IL_SetNewMass
	...
	IL_Vehicle_Chat =
	{
		...
		if (_mass_info && IL_Mass) then
		{
			...
			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Fahrzeugewicht: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1 Kg</t><br/>", _v_def_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Zuladung: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1 Kg</t><br/>", _cargo_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Ladegewicht: </t>";
